...
I enjoy turning complex requirements into elegant, efficient solutions — always guided by best practices and teamwork.

- 🟣 Experienced in **.NET Core**, **REST APIs**, and modern **software design patterns**  
- 🔴 Interested in **Microservices Architecture** and **Domain-Driven Design (DDD)**  
- 🟢 Hands-on experience with **RabbitMQ**, **Redis**, **ElasticSearch**, and **Kibana**  
- 🧩 Skilled in building **middleware** and integrating **messaging** systems  
- 🐳 Comfortable working with **Docker** and containerized applications  
- 💬 Strong collaborator who values clarity, reliability, and shared learning  
